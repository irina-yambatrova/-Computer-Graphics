...
namespace
{
	...
	const float SPHERE_PRECISION = 2 * float(M_PI);
	...
	, m_programFixed(CShaderProgram::fixed_pipeline_t())
{
	...
	m_lineMat.SetDiffuse(DARK_BLUE_RGBA);
	m_lineMat.SetAmbient(DARK_BLUE_RGBA * AMBIENT_SCALE);
